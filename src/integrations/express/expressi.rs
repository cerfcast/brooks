...
#[derive(Debug)]
pub(crate) struct BrooksExpressRequestBuilder {
    builder: RequestBuilder,
}

pub(crate) struct BrooksExpressRequest {
    pub(crate) request: Request<Vec<u8>>,
}

impl BrooksExpressRequestBuilder {
    pub fn new() -> Self {
        BrooksExpressRequestBuilder {
    ...
    pub fn finalize_with_body(self, body: Vec<u8>) -> http::Result<BrooksExpressRequest> {
        Ok(BrooksExpressRequest {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn brooks_express_request_builder_new() -> *const c_void {
    Box::into_raw(Box::new(BrooksExpressRequestBuilder::new())) as *const c_void
}
...
#[allow(clippy::missing_safety_doc)]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn brooks_express_request_builder_set_header(
    crb: *mut c_void,
    raw_hn: *const c_char,
    raw_hv: *const c_char,
) -> *const c_void {
    let crb = Box::from_raw(crb as *mut BrooksExpressRequestBuilder);
...
#[allow(clippy::missing_safety_doc)]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn brooks_express_request_builder_set_uri(
    crb: *mut c_void,
...
#[allow(clippy::missing_safety_doc)]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn brooks_express_request_builder_set_host(
    crb: *mut c_void,
...
#[allow(clippy::missing_safety_doc)]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn brooks_express_request_builder_set_method(
    crb: *mut c_void,
...
#[allow(clippy::missing_safety_doc)]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn brooks_express_request_builder_finalize_with_body(
    crb: *mut c_void,
    body: *const c_char,
) -> *const c_void {
    let crb = Box::from_raw(crb as *mut BrooksExpressRequestBuilder);
